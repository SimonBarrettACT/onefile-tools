    ...
    public function index_get()
    {
       ...
       foreach($records as $record):
           ...
           if ($keyFound) :
               ...
               try {
                   $response = $this->user->archiveUser($learnerID);
                   ++$counter;
                   $rateLimiter();
               } catch (Exception $e) {
        ...
        $return = array('status' => true, 'message' => "Job completed with $counter archived accounts and $failed failures.");
